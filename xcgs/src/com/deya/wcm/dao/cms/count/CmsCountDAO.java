...
public class CmsCountDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, CmsCountBean> getCatListByReleaseDtime(Map<String, String> mp){

        mp.remove("cat_ids");
        List<Map> result = DBManager.queryFList("getCatListByReleaseDtime", mp);
    ...
    public static List<InfoBean> getInfoListByCat(Map<String, String> mp){
        ...
        return DBManager.queryFList("getInfoListByCat", mp);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, CmsCountBean> getDeptListByReleaseDtime(Map<String, String> mp){

        mp.remove("dept_ids");
        List<Map> result = DBManager.queryFList("getDeptListByReleaseDtime", mp);
        ...
        for(Map m : result ){
            ...
            CmsCountBean cmb = new CmsCountBean();
            cmb.setCat_id(Integer.parseInt(dept_id));
            cmb.setCat_name(dept_name);             //此处是因为CmsCountBean没有其他属性，所以临时用cat_cname用一下，代表dept_name
            cmb.setCount(Integer.parseInt(count));
            ret.put(dept_id, cmb);
        }
        return ret;
    ...
    public static List<InfoBean> getInfoListByDept(Map<String, String> mp){
        ...
        return DBManager.queryFList("getInfoListByDept", mp);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, CmsCountBean> getAuthorListByReleaseDtime(Map<String, String> mp){

        List<Map> result = DBManager.queryFList("getAuthorListByReleaseDtime", mp);

        Map<String, CmsCountBean> ret = new HashMap<String, CmsCountBean>();
        for(Map m : result ){
            String count = m.get("COUNT").toString(); // 取得返回的count列
            String user_name = m.get("AUTHOR").toString();

            CmsCountBean cmb = new CmsCountBean();
            cmb.setUser_name(user_name);
            cmb.setCount(Integer.parseInt(count));
            ret.put(user_name, cmb);
        }
        return ret;
    }
    ...
    public static List<InfoBean> getInfoListByAuthor(Map<String, String> mp){
        ...
        return DBManager.queryFList("getInfoListByAuthor", mp);
    }
    ...
    public static List<InfoBean> getInfoHitsByReleaseDtime(Map<String, String> mp){
        ...
        return DBManager.queryFList("getInfoHitsByReleaseDtime", mp);
    }
     ...
     * @return
     */
    public static Map<String, CmsCountBean> getCatHitsByReleaseDtime(Map<String, String> mp){

        List<Map> result = DBManager.queryFList("getCatHitsByReleaseDtime", mp);
