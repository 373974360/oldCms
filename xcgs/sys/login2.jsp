...
<%
	...
	if(key != null && !"".equals(key.trim()))
	{
		...
		if(!com.deya.wcm.startup.ServerListener.isLicenseRight || !com.deya.wcm.startup.ServerListener.isLicenseRight){
...
input,img a{vertical-align:middle; magrin-right:15px;}
			...
			<div class="login">
				<div class="tp">
					<form id="form1" name="form1" method="post" action="login.jsp" target="submitFrame">
						<span class="left tp_name" style="padding-left:100px;">用户名：</span>
						...
						<span class="left"><input id="btnSubmit" name="btnSubmit" type="submit" onClick="loginWCM()" class="btn" value="登 录" /><input id="btnReset" name="btnReset" type="reset" class="btn"  value="重 置" /></span>
