...
<script type="text/javascript">
    ...
    {
		/*
        editAreaLoader = CodeMirror(document.getElementById(textareaID), {
            mode: "javascript",
		...
		*/
		...
		editAreaLoader = CodeMirror.fromTextArea(document.getElementById(textareaID), {
			mode: mixedMode,
...
<table id="ware_table" class="table_form_ware" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
		...
		<tr>
			...
			<td style="border:1px solid #9DBFDD;">
				...
				-->
				<form><textarea id="ware_content" name="ware_content"></textarea></form>
                <!--<div id="ware_content" name="ware_content" style="width:90%;height:437px;"></div>-->
			</td>
		</tr>
		<tr>
			<th>宽度：</th>
