	...
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>		
			<td align="left" valign="middle" id="dept_search" class="search_td fromTabs" >
				...
				<input id="btn1" name="btn1" type="button" onclick="updateRecord(table,'author_id','openUpdateAuthorDataPage()');" value="修改" />
				<input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'author_id','deleteAuthorData()');" value="删除" />			
