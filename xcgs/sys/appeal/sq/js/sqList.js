...
function initTable(){
    ...
    if(sq_status == 3)
        colsList.add(setTitleClos("over_dtime","办结时间","120px","","",""));
    colsList.add(setTitleClos("do_dept_name","处理部门","200px","","",""));
    ...
    colsList.add(setTitleClos("sq_ip","IP地址","180px","","",""));
    colsList.add(setTitleClos("sq_dtime","来信时间","120px","","",""));
    //colsList.add(setTitleClos("xj_flag","信件标识","70px","","",""));
    colsList.add(setTitleClos("publish_status","发布状态","120px","","",""));
