...
<div>
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>	
		   ...
		   <input class="Wdate" type="text" name="start_time" id="start_time" size="11" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true,readOnly:true})" readonly="true" style="width:100px">&nbsp;--&nbsp;<input class="Wdate" type="text" name="end_time" id="end_time" size="11" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true,readOnly:true})" readonly="true" style="width:100px">
