...
<table style="width:100%" border="0" cellpadding="0" cellspacing="0" >
	<tr>
        ...
        <td width="270px">
            <div>
                <input id="all_cat_ids" type="checkbox" class="checkBox_mid" onclick="allSelected()" style="margin-right:5px;"/>全选&nbsp;&nbsp;
                <input id="selectedCateNames" readonly="readonly" style="vertical-align:middle;"/>
