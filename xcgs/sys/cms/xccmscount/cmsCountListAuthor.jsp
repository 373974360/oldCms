...
<script type="text/javascript" src="js/cmsCountListAuthor.js"></script>
...
<table style="width:100%" border="0" cellpadding="0" cellspacing="0" >
	<tr>
        <td width="75px">
            <span class="f_red">*</span>输入作者:
        </td>
        <td width="230px">
            <div>
                <input id="authorNames" style="vertical-align:middle;"/>
                <input id="all_authors" type="checkbox" class="checkBox_mid" onclick="allSelected()" style="margin-right:5px;"/>全部&nbsp;&nbsp;
            </div>
        </td>
    	<td width="75px">
