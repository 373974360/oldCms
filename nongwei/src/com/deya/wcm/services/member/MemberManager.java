...
public class MemberManager implements ISyncCatch{
        ...
        if(mem_reg_map.containsKey(me_account))
        {
            ...
            if(me_password.equals(mrb.getMe_password()))
            {
                ...
                if(mb != null)
                {
                    ...
                    lub.setUser_id(Integer.parseInt(mb.getMe_id()));
                    lub.setUser_name(mb.getMe_nickname());
                    lub.setUser_realname(mb.getMe_realname());
    ...
    {
        mb.setAdd_time(DateUtil.getCurrentDateTime());
        mb.setUpdate_time(DateUtil.getCurrentDateTime());
