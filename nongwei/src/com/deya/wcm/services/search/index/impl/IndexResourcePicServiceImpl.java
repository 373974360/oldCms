...
import com.deya.wcm.dao.search.impl.IndexResourcePicDaoImpl;
...
//				    	  }
			  ...
			  indexBeanInfo.setId(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("pic_id")+(String)infoMap.get("info_id")));
			  indexBeanInfo.setTitle(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("pic_title")));
			  indexBeanInfo.setApp_id(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("app_id")));
			  indexBeanInfo.setContent(HtmlRegexpUtil.filterHtml(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("pic_note"))+com.deya.util.FormatUtil.formatNullString((String)infoMap.get("pic_content"))));
			  indexBeanInfo.setUrl(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("pic_path")));
