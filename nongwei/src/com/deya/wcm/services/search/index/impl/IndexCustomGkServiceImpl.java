...
import com.deya.wcm.dao.search.impl.IndexCustomGkDaoImpl;
...
//				    }
			  ...
			  //indexBeanXxgk.setContent(HtmlRegexpUtil.filterHtml(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("gk_content"))));
