...
/**
 * <p>Title: HTML相关的正则表达式工具类</p>
 * <p>Description: 包括过滤HTML标记，转换HTML标记，替换特定HTML标记</p>
...
public final class HtmlRegexpUtil {
  ...
  //判断所给出字符串是否包含在html标签中，如果是，返回true
    ...
    public static void main(String[] args){
        ...
        //String s="<info><infid>198</infid><inftitle>陕鼓超额完成30亿产值目标</inftitle><inftime>2007-01-08</inftime><infcounts>165</infcounts><hot>yes</hot><new>no</new></info>";
