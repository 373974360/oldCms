...
public class FormatUtil {
    ...
    {
        try {
            String before = DateUtil.getDateBefore(date,day);
            return before;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    {
        try {
            String before = DateUtil.getDateString(DateUtil.getDateAfter(date,day));
            return before;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    {
    	return HtmlRegexpUtil.filterHtml(content);
    }
