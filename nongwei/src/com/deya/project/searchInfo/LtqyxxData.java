...
public class LtqyxxData {
    private static int cur_page = 1;
    private static int page_size = 15;

    public static void getLtqyxxSearchCon(String params, Map<String, String> con_map) {
    ...
    public static TurnPageBean getLtqyxxCount(String params) {
        Map con_map = new HashMap();
        getLtqyxxSearchCon(params, con_map);

        TurnPageBean tpb = new TurnPageBean();
        tpb.setCount(Integer.parseInt(LtqyxxManager.getLtqyxxCount(con_map)));
    ...
    public static List<LtqyxxBean> getLtqyxxList(String params) {
        Map con_map = new HashMap();
        getLtqyxxSearchCon(params, con_map);
        ...
        return LtqyxxManager.getLtqyxxList(con_map);
    }

    public static List<LtqyxxBean> getLtqyxxHotList(String params) {
        Map con_map = new HashMap();
        getLtqyxxSearchCon(params, con_map);
    ...
    public static LtqyxxBean getLtqyxxObject(String id) {
