...
public class PriceInfoData {
    ...
    public static List<PriceCollectBean> getPriceCollectList(String params){
        Map<String,String> con_map = new HashMap<String,String>();
        getPriceCollectSearchCon(params,con_map);
        int start_num  = Integer.parseInt(con_map.get("start_num"));
        int page_size  = Integer.parseInt(con_map.get("page_size")) + start_num;
        List<PriceCollectBean> result =  DayCollectManager.getPriceCollectList(con_map);
        List<PriceCollectBean> returnResult = new ArrayList<PriceCollectBean>();
