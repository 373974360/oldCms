...
function createTable(){
	...
	if(beanList.size() != 0) {
		...
		treeHtmls += "<tr><td colspan=\"6\" width=\"1032\">暂无数据...</td></tr>" + "</tbody>"+"<tfoot>" +"<td colspan=\"5\"></td>"+" </tfoot>";
	}
