...
<div>
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>		
			...
			<input id="btn1" name="btn1" type="button" onclick="openFieldsListPage();" value="选择元数据" class="system hidden"/>
			<!-- 
			...
			<input id="btn2" name="btn6" type="button" onclick="publicSelectCheckbox( table, 'model_id', 'updateModelDisabled(0)')" value="启用" class="system hidden"/>
			 -->	
			 <input id="btn303" name="btn3" type="button" onclick="deleteRecord(table,'id','deleteInfo()');" value="删除" />
			<input id="btn2" name="btn2" type="button" onclick="saveFormSort();" value="保存排序" />
