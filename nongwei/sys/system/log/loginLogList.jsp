...
<html>
  <head>
	...
	<script type="text/javascript" src="js/loginLogList.js"></script>
		...
		<tr>		
			<td align="right" valign="middle" id="dept_search" class="search_td fromTabs" >
				...
				<select id="orderByFields" class="input_select" onchange="csLogSortHandl(this.value)">
					<option value="audit_id,desc" selected="selected">按时间倒序(默认)</option>
					<option value="audit_id,asc" >按时间顺序</option>
				</select>
