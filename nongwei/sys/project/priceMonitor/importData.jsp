...
<head>
    ...
    <SCRIPT LANGUAGE="JavaScript">
        ...
        $(document).ready(function () {
            ...
            publicUploadButtomAllFile2("uploadify2",true,false,"",false,0,top.current_site_id,"fileSave2");
            publicUploadButtomAllFile2("uploadify3",true,false,"",false,0,top.current_site_id,"fileSave3");
        ...
        function fileSave(path)
        {
            ...
            if(jsonrpc.PriceInfoRPC.importPfLs(path,user_id,top.current_site_id,scName))
            {
                top.msgAlert("数据导入成功");
            }
            else
        ...
        function fileSave2(path)
        {
            ...
            if(jsonrpc.PriceInfoRPC.importCdjg(path,user_id,top.current_site_id,scName))
            {
                top.msgAlert("数据导入成功");
            }
            else
        ...
        function fileSave3(path)
        {
            ...
            if(jsonrpc.PriceInfoRPC.importNzjg(path,user_id,top.current_site_id,scName))
            {
                top.msgAlert("数据导入成功");
            }
            else
