...
<head>
    ...
    <SCRIPT LANGUAGE="JavaScript">
        ...
        function subSearch() {
            ...
            parent.getCurrentFrameObj().searchHandl(source,con);
    ...
    <div id="surveyCategory">
        <table class="table_form" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td align="right" width="150px" class="content_td">数据来源&nbsp;：</td>
                <td></td>
                <td class="content_td">
    ...
    <table class="table_option" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" valign="middle" style="text-indent:100px;">
                ...
                <input id="userAddCancel" name="btn1" type="button" onclick="parent.CloseModalWindow()" value="关闭"/>
            </td>
        </tr>
    </table>
    <span class="blank3"></span>
