...
function addTab(isColseBar, page_path, titles) {
    ...
    var tmpLi = "<li id=\"tab_" + index + "\"  class=\"\"><div><div><a href=\"javascript:void(0)\" class=\"tabs-inner\" onclick=\"tabOnclick('" + index + "');\"><span class=\"tabs-title tabs-closable\">信息维护</span><span class=\"tabs-icon\"></span></a>" + strColseBar + "</div></div></li>";
    if ($(".tabs").length == 0) {
