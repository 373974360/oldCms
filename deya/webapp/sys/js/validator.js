...
Validator = function(){
    ...
    this.checkChinese=function (value, name,booleanFlag,input_name){
        ...
        if (reg.test(value)) {
            ...
            this.check_result = false;
            this.addError(input_name, "【" + name + "】项中只能填写中文,参考格式: ");
            return false;
        }
    }
...
function checkGkDataTimeAfter(startId, endId, input_name){
    val.isFocus = false;
    var styear = $("#" + startId).val();
    var endyear = $("#" + endId).val();
    if (styear != '' && endyear != '') {
        ...
        dt1=new Date(arr_dt1[1],arr_dt1[2],arr_dt1[3],arr_dt1[4],arr_dt1[5],arr_dt2[6]);
        ...
        if(dt2 < dt1)
        {
            ...
            val.addError(input_name,"成文日期不能大于发布时间！");
            return false;
        }
    }
}
