<%@ page import="com.yinhai.sso.SyncOrg"%><%@ page import="java.util.List"%><%@ page import="com.deya.wcm.bean.org.dept.DeptBean"%><%@ page contentType="application/json; charset=utf-8"%>
<%@ page language="java"%>
<%
