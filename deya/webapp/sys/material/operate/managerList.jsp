...
<table class="table_option fromTabs" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td align="left" valign="middle" class="hidden">
        ...
        <td align="right" valign="middle" id="user_search" class="search_td">
            ...
            <div class="hidden">
            <input type="text" id="beignTime" name="beignTime" size="11" class="input_text" value=""
                   onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"
                   readonly="true">至&nbsp;<input type="text" id="endTime" name="endTime" size="11" class="input_text"
                                                 value=""
                                                 onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                 readonly="true"></div>
                    ...
                    <table class="table_option fromTabs" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" valign="middle" style="padding-top:4px;" width="160px">
                                ...
                                <span class="showList detail_list pointer"
                                      onclick="showSuCai('detail_list',this)">详细列表</span>
                                <span class="blank3"></span>
                            </td>
                            <td align="left" valign="middle" style="padding-top:4px;">
                                <span onclick="selectSuCai('all')" class="pointer">全选</span> | <span
                                    onclick="selectSuCai('other')" class="pointer">反选</span>
                                <span class="blank3"></span>
                            </td>
                            ...
                            <td align="right" valign="middle" style="width:129px;overflow:hidden;">
                                ...
                                <div style="float:left;text-align:left;">&#160;
                                    <input class="hidden" id="btn3" name="btn3" type="button" onclick="MoveClick()" value="转移"/>
                                    <input class="hidden" d="btn3" name="btn3" type="button" onclick="MateInfoClick('1',site_id)"
                                           value="编辑"/>
                                    <input id="btn3" name="btn3" type="button" onclick="MateInfoClick('2',site_id)"
                                           value="删除"/></div>
                            </td>
                            <td style="width:20px;"></td>
                        </tr>
...
<div id="fileUploadSpan" name="fileUploadSpan" class="hidden" title="上传素材">
    ...
    <div class="msg_right_div">
        <table border="0" cellpadding="0" cellspacing="0" align="left" height="270px" style="width:100%;">
            <tr>
                <td valign="middle" align="left" class="lineHeight20px">
    ...
    <div class="textCenter">
        ...
        <input id="i005" name="i005" type="button"
               onclick="CloseUploadSpan();jQuery('#uploadify').uploadifyClearQueue()" hidefocus="true" value="取消所有上传"/>
    </div>
    <span class="blank3"></span>
</div>
