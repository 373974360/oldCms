        ...
        function setScrollHandl() {
            $(window).scroll(function () {
                ...
                if (o.scrollTop() + o.height() + 50 >= $(document).height() && o.scrollTop() > 50) {
                    ...
                    showMateInfosList(f_id, site_id, "custom", imgDomain, parent.page_size, "");
                }
                /*
...
//            eval("parent." + handl_name + "('" + urls + "','" + names + "')");
//            window.close();
            eval("getCurrentFrameObj()."+handl_name+ "('" + urls + "','" + names + "')");
            CloseModalWindow();
        }

        //选择图片，并返回路径
        function selectPicUrlHandl(url, oldname) {
            eval("getCurrentFrameObj()."+handl_name+ "('" + url + "','" + oldname + "')");
            CloseModalWindow();
//            eval("parent." + handl_name + "('" + url + "','" + oldname + "')");
//            window.close();
        }
    ...
    <tr>
        <td width="160px" valign="top">
            <div id="leftMenuBox">
                ...
                <div><input type="text" id="searchkey" name="searchkey" style="width:110px"/><input id="searchButton"
                                                                                                    name="btn1"
                                                                                                    type="button"
            ...
            <table class="table_option fromTabs" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="width:190px;overflow:hidden;">
                        <div style="float:right;text-align:left;">&nbsp;&nbsp;<input id="returnButton" class="hidden"
                                                                                     name="btn1" type="button"
                                                                                     onclick="returnSelectedPic()"
                                                                                     value="确定"/></div>
                        <div class="hidden" style="float:right;text-align:left;"><input type="file" name="uploadify"
                                                                                        id="uploadify"/></div>
                        <span class="blank3"></span>
                    </td>
