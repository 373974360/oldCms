...
$(document).ready(function(){
	...
	{		
		...
		$("#addButton").click(updateMetaData);
	}
	else
	{
		$("#addButton").click(addMetaData);
	}
});
...
<table id="metadata_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<th><span class="f_red">*</span>定义：</th>
			<td >
		...
		<tr>
			<th><span class="f_red">*</span>值域：</th>
			<td >
			...
			<th><span class="f_red">*</span>短名：</th>
			<td >
		...
		<tr>
			<th><span class="f_red">*</span>是否可选：</th>
			<td >
			...
			<th><span class="f_red">*</span>最大出现次数：</th>
			<td >
				<input id="meta_maxtimes" name="meta_maxtimes" type="text" class="width200" value="0" onblur="checkInputValue('meta_maxtimes',false,20,'最大出现次数','checkInt')"/>0为不限制次数
			</td>
		</tr>		
		<tr>
			<th>元数据类型：</th>
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" valign="middle" style="text-indent:100px;">
			...
			<input id="userAddReset" name="btn1" type="button" onclick="formReSet('metadata_table',meta_id)" value="重置" />	
			<input id="userAddCancel" name="btn1" type="button" onclick="locationMetaData();" value="取消" />	
		</td>
	</tr>
</table>
<span class="blank3"></span>
