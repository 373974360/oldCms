...
function openAddPage(){ 
	OpenModalWindow("修改服务器","/sys/control/server/server_add.jsp",500,260);
}
...
function openUpdatePage(){
	...
	OpenModalWindow("修改服务器","/sys/control/server/server_add.jsp?server_id="+selectIDS,500,260);
}

//打开查看页面
function openViewPage(s_id)
{  
	OpenModalWindow("查看服务器信息","/sys/control/server/server_view.jsp?server_id="+s_id,500,260);
}
