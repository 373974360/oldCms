...
<%@page import="java.util.*,com.deya.wcm.services.appeal.sq.SQManager,com.deya.wcm.bean.appeal.sq.*"%>
<%@page import="com.deya.wcm.services.org.user.*,com.deya.wcm.bean.org.deskDeskTopBean,com.deya.wcm.services.zwgk.node.*"%>
<%@page import="com.deya.wcm.services.cms.info.*,com.deya.wcm.bean.cms.info.*,com.deya.wcm.services.control.site.*"%>
<%
...
{
	addTab(true,url,title);
}

function openSQPage(sq_id)
{
	addTab(true,"/sys/appeal/sq/sq_add.jsp?sq_id="+sq_id+"&top_index="+curTabIndex,"信件管理");
}

function openInfoList(app_id,site_id)
{
	addTab(true,"/sys/cms/info/article/verifyInfoList.jsp?app_id="+app_id+"&site_id="+site_id,"待审信息");
}
