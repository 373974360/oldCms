...
<table id="role_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr id="system_selected" style="display:none">
			<th>所属应用系统：</th>
			<td class="width250">
				<div style="border:1px solid #9DBFDD;width:303px;height:160px;overflow:auto;background:#FFFFFF;">
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" valign="middle" style="text-indent:100px;">
			<input id="userAddButton" name="btn1" type="button" onclick="CloseModalWindow();" value="关闭" />
		</td>
	</tr>
</table>
<span class="blank3"></span>
