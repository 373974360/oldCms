...
<head>
    ...
    <script type="text/javascript" src="js/weekCollect.js"></script>
...
<body>
    ...
    <table width="800px" class="table_form hidden" border="1" cellpadding="0" cellspacing="0" id="result_table" name="result_table">
        <tr class="data_title">
            <td colspan="5" align="center">西安市主要蔬菜价格监测表</td>
        </tr>
        <tr class="data_title">
            <td colspan="5" style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;报送单位：西安市农业信息网络中心<span style="float: right; display: inline; margin-right: 20px;">日期：<span id="showDate"></span></span></td>
        </tr>
        <tr class="data_title">
            <td>商品名称</td>
            <td>单位</td>
