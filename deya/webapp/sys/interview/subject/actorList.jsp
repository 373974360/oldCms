...
<div>
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>	
			<td class="fromTabs">
				<input id="btn1" name="btn1" type="button" onclick="addActor('add_category.html')" value="添加" />
				<input id="btn1" name="btn1" type="button" onclick="updateRecord(table,'id','fnUpdateActor()');" value="修改" />
				<input id="btn3" name="btn3" type="button" onclick="saveSort()" value="保存排序" />
				<input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'id','batchDelSubActors()')" value="删除" />		
