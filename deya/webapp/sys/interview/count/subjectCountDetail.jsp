...
<head> 
   ...
   $(document).ready(function () {	
	...
	function initTable(){
		...
		colsList.add(setTitleClos("sub_name","访谈主题名称","","","",""));　
		colsList.add(setTitleClos("category_name","访谈模型","20%","","",""));	　
		colsList.add(setTitleClos("user_count","访问人数","20%","","",""));
		colsList.add(setTitleClos("chat_count","网友发言数","20%","","",""));
	...
	function showList(){	
		...
		var order_type = request.getParameter("ot");
		...
		var m = SubjectRPC.getHotCount(s_tiem,e_tiem,ids,order_type,count_num,time_type);
		...
		if(order_type == "user")
		{
			$("#order_type").text("按照访问人数");
		}
		else
			$("#order_type").text("按照网友发言条数");
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
	<tr>	
		<td class="fromTabs">
			<input id="addButton" name="btn1" type="button" onclick="window.location.href='subjectCount.jsp?site_id=<%=site_id%>'" value="统计条件" />	
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		 ...
		 <tr>
			<td height="20px" align="left" >&#160;排行依据：&#160;<span id="order_type"></span>&#160;显示条数：&#160;<span id="count_num"></span>					
			</td>
		 </tr>
		 <tr>
			<td height="20px" align="left" >&#160;访谈模型：&#160;<span id="category_names"></span>				
			</td>
		 </tr>
</table>	
<div id="table"></div>
