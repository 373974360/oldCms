...
<script type="text/javascript" src="js/memberAssessList.js"></script>
...
{
    var catList = jsonrpc.MemberManRPC.getMemberCategoryList();
    catList = List.toJSList(catList);
    for (var i = 0; i < catList.size(); i++) {
        var selObj = $("#mcat_id");
        var value = catList.get(i).mcat_id;
        var text = catList.get(i).mcat_name;
...
<table style="width:100%" border="0" cellpadding="0" cellspacing="0" >
    ...
    <tr>
        ...
        <div style="float:left">
            <input id="selectedCateNames" readonly="readonly" value=" 市场供求"/>
        </div>
    ...
    <tr>
        <td>
            <span class="f_red">*</span>选择区县:
        </td>
        <td>
            <select id="mcat_id" name="mcat_id">
