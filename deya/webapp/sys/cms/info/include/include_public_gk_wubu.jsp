...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
        <tr>
			...
			-->
			<th style="width:40px;">文号：</th>
			<td width="142">
				<input id="generate_dtime" name="generate_dtime" type="hidden" />
				<input id="doc_no" name="doc_no" type="text" style="width:140px;" maxlength="80" value="" onblur="checkInputValue('doc_no',true,160,'文号','')"/>
			</td>		
			<th style="width:45px;">签发人：</th>
			<td>
				<input id="gk_signer" name="gk_signer" type="text" style="width:140px;" maxlength="80" value="" onblur="checkInputValue('gk_signer',true,80,'签发人','')"/>
			</td>		
		</tr>
	</tbody>
</table>

<table id="isChangeTime" style="display:none" class="table_form" border="0" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <!--
        <th style="width:85px;">生成日期：</th>
