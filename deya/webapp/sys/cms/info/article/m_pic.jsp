	...
	if(picList != null && picList.length > 0)
	{
		if(picList.length > 1)
		{
			...
			picList.each(function(){
				...
				strUrl+="<tr><td><img src="+$(this).attr("src")+" height='100' width='100'></td></tr>";
				strUrl+="<tr><td style='padding-left:50px;'><input type='radio' name='radio' onchange='addthumb_url(this.value)' value='"+$(this).attr("src")+"'></td></tr>";
				if(i>0 && i%4==0)
				{
		...
		{
			$("#thumb_url").val(picList.first().attr("src"));
		}
	...
	<tbody>
		...
		<tr>
			...
			<td style="">
				...
				<script id="pic_content" type="text/plain" style="width:95%;height:300px;"></script>
				<div class="hidden" id="word_count_div"></div>
			<span class="blank9"></span>
			<input class="hidden" id="is_remote" name="is_remote" type="checkbox" /><label for="is_remote">远程图片本地化</label>&nbsp;&nbsp;
