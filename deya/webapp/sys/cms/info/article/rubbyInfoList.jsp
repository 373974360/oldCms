...
<head>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            colsList.add(setTitleClos("released_dtime", "发布时间", "100px", "", "", ""));
            colsList.add(setTitleClos("hits", "点击次数", "100px", "", "", ""));
        ...
        function showList() {
            ...
            table.getCol("title").each(function (i) {
                ...
                if (i > 0) {
                    ...
                    if(beanList.get(i - 1).cat_id==10058||beanList.get(i - 1).cat_id==10062||beanList.get(i - 1).cat_id==10063){
            ...
            table.getCol("actions").each(function (i) {
                if (i > 0) {
                    ...
                    str += "<li name='btn308' class='ico_reduce'><a title='还原' href='javascript:doReduce(" + (i - 1) + ")' style='width:16px;height:16px;'>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>";
                    ...
                    str += "<li name='btn309' class='ico_Clear' ><a title='彻底删除' href='javascript:doClearOneInfo(" + (i - 1) + ")' style='width:16px;height:16px;'>&nbsp;&nbsp;&nbsp;&nbsp;</a></li>";
                    $(this).html(str + "</ul>");
                }
            });
