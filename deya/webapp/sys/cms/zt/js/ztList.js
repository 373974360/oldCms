...
{
	addTab(true,"/sys/cms/category/category_add.jsp?top_index="+curTabIndex+"&app_id="+app_id+"&parentID=0&cat_type=1","修改目录");
}
...
function openUpdateCategoryPage(cid)
{
	...
	addTab(true,"/sys/cms/category/category_add.jsp?top_index="+curTabIndex+"&id="+id+"&cat_type=1&app_id="+app_id,"修改目录");
}
