...
<div>
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>		
			<td class="fromTabs">
				递交渠道：
				<select id="model_id" class="input_select width120" onchange="modelSearch(this.value)">
					<option selected="selected" value="">全部</option>
				</select>
				来信时间：
				<select id="sq_dtime" class="input_select width70" onchange="dateSearch(this.value)">
			...
			<td align="right" valign="middle" id="dept_search" class="search_td fromTabs" >
				<select id="searchFields" class="width80">
				...
				<select id="orderByFields" class="input_select" onchange="sortSQList(this.value)">
					<option selected="selected" value="sq_id,desc">按时间倒序(默认)</option>
					<option value="sq_id,asc">按时间顺序</option>
				</select>
	...
	<tr>
		<td align="left" valign="middle">
			...
			<!--input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'sq_id','deletesq()');" value="删除" /-->			
		</td>
	</tr>
   </table>	
</div>
