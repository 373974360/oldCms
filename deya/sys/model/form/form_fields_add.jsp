...
<script type="text/javascript" src="../fields/js/jquery_selecter.js"></script>
<script type="text/javascript" src="js/form_fields_add.js"></script>
<script type="text/javascript" src="../fields/js/fieldsAddUtil.js"></script>
...
<table id="form_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
	   <tr>
			...
			<td >
				c_<input id="field_enname" name="field_enname" type="text" class="width200" style="width: 186px" value="" onblur="checkInputValue('field_enname',false,20,'字段名称','checkLetterL')"/>
			    注：字段名由字母、数字、下划线组成
			</td>	
		</tr>
		<tr>
	...
	<div id="textDiv" style="display">
		<table class="table_form" border="0" id="form_table1" cellpadding="0" cellspacing="0">
		    <tbody>
			   <tr>
		...
		<table class="table_form" border="0" id="form_table4" cellpadding="0" cellspacing="0">
		    <tbody>
			   <tr style="display:none">
					<th>数据类型：</th>
					<td >
					   <input type="radio" name="data_type" id="date_type1" value="1" onclick="data_type_select1()"><label> 自定义</label>	
								&nbsp;&nbsp;<input type="radio" name="data_type" id="date_type1" value="2" checked="true"  onclick="data_type_select2()"> <label>数据字典</label>
					</td>	
				</tr>
