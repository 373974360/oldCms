...
import com.deya.wcm.services.search.index.impl.IndexCustomGkServiceImpl;
import com.deya.wcm.services.search.index.impl.IndexCustomServiceImpl;
...
public class IndexManager_svn {
	...
	public static void addKeys(String title,String site_id){
		//com.deya.project.shanghaikewei.searchkeys.SearchCustomKeyService.addKeys(title, site_id);
	}
