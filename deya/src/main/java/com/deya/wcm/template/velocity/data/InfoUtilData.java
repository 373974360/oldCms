...
public class InfoUtilData {
        ...
        }else
        {
            ...
            for(int i=0;i<tempA.length;i++)
            {
                ...
                if(cb != null)
                {
                    ...
                    cat_sql += " ca.cat_id in ( select cat_id from cs_info_category where cat_position like '"+cb.getCat_position()+"%' "+constr+" ) ";
                }
            }
    ...
    public static List getAllInfoList(String params){
        ...
        String gk_index = con_map.get("gk_index");
