...
import com.deya.analyzer.cfg.Configuration;
...
public class Dictionary {
	 ...
	 * 分词器默认字典路径 
	 */
	public static final String PATH_DIC_MAIN = "/com/deya/analyzer/dic/main.dic";   //建立一个主词典实例
	public static final String PATH_DIC_SURNAME = "/com/deya/analyzer/dic/surname.dic";  //加载姓氏词典
	public static final String PATH_DIC_QUANTIFIER = "/com/deya/analyzer/dic/quantifier.dic"; //加载量词词典
	public static final String PATH_DIC_SUFFIX = "/com/deya/analyzer/dic/suffix.dic";  //建立一个后缀词典实例
	public static final String PATH_DIC_PREP = "/com/deya/analyzer/dic/preposition.dic";  //加载介词\副词词典
	public static final String PATH_DIC_STOP = "/com/deya/analyzer/dic/stopword.dic";   //加载停止词词典
	
	public static final String PATH_DIC_FILES = "/com/deya/analyzer/dic/files/"; //扩展词库的存放路径
