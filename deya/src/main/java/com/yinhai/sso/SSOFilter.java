...
public class SSOFilter extends AbstractConfigurationFilter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain filter)
        ...
        if (this.clientLogoutUrl.equals(url)) {
            ...
            String tmp = new String(this.ssoLogoutUrl);
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        this.ssoLogoutUrl = filterConfig.getInitParameter("ssoLogoutUrl");
    }
