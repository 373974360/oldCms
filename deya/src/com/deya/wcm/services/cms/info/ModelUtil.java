...
public class ModelUtil {
        ...
        try {
            ...
            if (ModelUtilDAO.addModel(ob, addSql, model_name, stl)) {
                ...
                if (ob instanceof java.util.HashMap) {
                    ModelBean modelBeanByEName = ModelManager.getModelBeanByEName(model_name);
                    InfoCustomService.addInfoCuston(modelBeanByEName.getModel_id() + "", (HashMap) ob);
                    return true;
                }
     ...
     * @return 取得的Object对象
     */
    public static Object select(String infoId, String siteId, String model_name) {//这里site_id未用上
        try {
            Map<String, String> mp = ModelConfig.getModelMap(model_name);
            String SelectSQL = "";
            if (mp != null) {
