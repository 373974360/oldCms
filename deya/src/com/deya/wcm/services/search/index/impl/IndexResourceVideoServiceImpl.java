...
import com.deya.wcm.dao.search.impl.IndexResourceVideoDaoImpl;
...
//				    	  }
			  ...
			  indexBeanInfo.setContent(HtmlRegexpUtil.filterHtml(com.deya.util.FormatUtil.formatNullString((String)infoMap.get("content"))));
