...
public class InfoDAO_bak {
	...
	public static List<InfoBean> getInfoBeanList(Map<String, String> map){
		...
		//{cat_id=10259, page_size=15, highSearchString=, start_num=0, sort_type=desc, info_status=8, site_id=CMSstcsm, 
		//app_id=cms, searchString2=, final_status=0, sort_name=ci.released_dtime desc,ci.id}
//		String sort_type = (String)FormatUtil.formatNullString(map.get("sort_type"));
//		if(sort_type.equals("asc")){
//			map.put("t_sort_type","desc");
//		}else if(sort_type.equals("desc")){
//			map.put("t_sort_type","asc");
//		}
//		String sort_name = (String)FormatUtil.formatNullString(map.get("sort_name"));
//		if(!sort_name.equals("")){
//			//if(sort_name.trim().endsWith("id")){
//			//	sort_name = sort_name + " asc";
//			//} 
//			map.put("t_sort_name",sort_name.replaceAll(" asc", " desc").replaceAll(" desc", " asc"));
//			map.put("tempt_sort_name",sort_name.replaceAll("ci.", "tempt.").replaceAll(" desc", " asc").replaceAll(" asc", " desc"));
//		}
