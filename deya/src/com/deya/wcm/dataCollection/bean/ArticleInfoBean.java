...
public class ArticleInfoBean {
    ...
    private String gk_signer_dtime = "";
    private String gk_input_dept = "";

    public String getGk_signer_dtime() {
        return this.gk_signer_dtime;
    }

    public void setGk_signer_dtime(String gk_signer_dtime) {
        this.gk_signer_dtime = gk_signer_dtime;
    }

    public String getGk_input_dept() {
        return this.gk_input_dept;
    }

    public void setGk_input_dept(String gk_input_dept) {
        this.gk_input_dept = gk_input_dept;
    }
