...
public class CollRuleBean
    ...
    private String signer_dtime_start = "";
    private String signer_dtime_end = "";
    private String input_dept_start = "";
    private String input_dept_end = "";

    public String getSigner_dtime_start() {
        return this.signer_dtime_start;
    }

    public void setSigner_dtime_start(String signer_dtime_start) {
        this.signer_dtime_start = signer_dtime_start;
    }

    public String getSigner_dtime_end() {
        return this.signer_dtime_end;
    }

    public void setSigner_dtime_end(String signer_dtime_end) {
        this.signer_dtime_end = signer_dtime_end;
    }

    public String getInput_dept_start() {
        return this.input_dept_start;
    }

    public void setInput_dept_start(String input_dept_start) {
        this.input_dept_start = input_dept_start;
    }

    public String getInput_dept_end() {
        return this.input_dept_end;
    }

    public void setInput_dept_end(String input_dept_end) {
        this.input_dept_end = input_dept_end;
    }
